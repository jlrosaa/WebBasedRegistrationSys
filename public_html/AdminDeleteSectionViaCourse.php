...
<div class="footer">
<h2 style="text-align:center">SUNY Gold Courses</h2>
...
<form name="DeleteSection" method="post" action="DeleteSection.php" onSubmit="validateform()">
  
  
  <div class="input-group" >
  	  <label><b>Enter the Course Id of the class you would like to delete a section for.<b></label>
  	  <input type="text" name="id">
  	</div>
  	
	
  <button type="submit" class="btn btn-outline-primary" name="DeleteSection">Submit</button> 	  
