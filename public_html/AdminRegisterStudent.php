...
<p><label>CRN: <input name="CRN" placeholder="# of credits" type="text" /> </label></p>

<p><button class="btn" name="add" type="submit">Continue</button><input type="reset" value="Clear" /></p>
