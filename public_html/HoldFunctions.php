...
<head><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
	<title>SUNY Gold Hold Functions</title>
	<style type="text/css">* 
{
...
<div class="dropdown-content"><a href="/CourseFunctions.php">Course Functions</a> <a href="/HoldFunctions.html">Hold Functions</a> <a href="/LocationFunctions.php">Location Functions</a> <a href="/TimeslotFunctions.php">Timeslot Functions</a><a href="UserFunctions.php">User Functions</a></div>
</div>
<a href="/Logout.php" onclick="return confirm('Are you sure you want to logout?')" style="float:right">Logout</a></div>

<div class="rightcolumn">
<div class="card">
<h2>Hold Functions</h2>

<div class="fakeimg" style="height:120px;"><br />
<a href="/CreateHold.php">Add Hold to Student</a><br />
<br />
<a href="/RemoveAHold.php">Remove a Hold from Student</a></div>
</div>
</div>
</body>
</html>