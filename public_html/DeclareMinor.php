<?php include('Minor.php') ?>

<!DOCTYPE html>
<html>
<head><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
	<title>SUNY Gold Declare Minor</title>
...
<div class="footer">
<h2>Declare a Minor</h2>

<div class="rightcolumn">
<div class="card">

<form name="Minor" form action="DeclareMinor.php" method="post" onSubmit="return validateform()"> 
...
<td>
<select name="UserId">
 <option disabled selected value> -- select a stuent -- </option>
<?php 
$db = mysqli_connect('localhost', 'systemdesign2018', 'System2018!', 'SUNYGOLD');
$sql = mysqli_query($db, "SELECT Distinct UserId FROM Students");
...
<td>
<select name="Minor">
 <option disabled selected value> -- select a minor -- </option>
<?php 
$db = mysqli_connect('localhost', 'systemdesign2018', 'System2018!', 'SUNYGOLD');
$sql = mysqli_query($db, "SELECT Distinct Minor FROM Minors");

while ($row = $sql->fetch_assoc())
{

echo "<option value='".$row["Minor"]."'>". $row['Minor'] . "</option>";
...
<p><button class="btn" name="DeclareMinor" type="submit">Submit</button><input type="reset" value="Clear" /></p>
