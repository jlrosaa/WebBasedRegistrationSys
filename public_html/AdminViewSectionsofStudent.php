<?php include('AdminDropStudentData.php')?>
...
// REGISTER USER
if (isset($_POST['SeeStudentsSections'])) {
 ...
 $_Session["UserId"]=$UserId;
     	...
     	$query ="SELECT Section.CRN, Section.CourseId, Section.BuildingName, Section.RoomNumber,Section.Course, Section.TimeSlot, Section.Semester, Section.Semester, Section.Year, Section.Professor, Section.Days, Section.Credits, Section.SeatsTaken, Section.Capacity
	FROM Enrolled
	LEFT JOIN Section ON Enrolled.CRN = Section.CRN WHERE UserId ='$UserId'";
	
	
	$result =   mysqli_query($db, $query);
	
        
      //  $query = "SELECT * FROM Enrolled WHERE UserId = '76'";
...
$sql1 = "SELECT * FROM Section WHERE CRN='$CRN'";
...
<h2 style="text-align:center">SUNY GOLD Sections</h2>
...
<form method="post" action="AdminViewSectionsofStudent.php" name="AdminDropStudent">
  

  	<div class="input-group" >
  	  <label><b>Enter the CRN of the Section You want to drop the Student from:</b></label>
  	  <input type="text" name="crn">
  	</div>
  	
  
  
    <button type="submit" class="btn btn-outline-primary" name="AdminDropStudent">Submit</button>
