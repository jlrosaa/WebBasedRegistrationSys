...
<form name="EditAUser" method="post" action="EditUserEmail.php" onSubmit="validateform()">
  ...
  <button type="submit" class="btn btn-outline-primary" name="EditUserEmail">Submit</button> 
