...
<head><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
	<title>SUNY Gold Search Schedule</title>
	<style type="text/css">* 
{
...
<form name="SearchAttendance" form action="AttendanceLook.php" method="post" > 
...
$sql = mysqli_query($db, "SELECT Distinct Course FROM Attendance");
...
<?php 
$db = mysqli_connect('localhost', 'systemdesign2018', 'System2018!', 'SUNYGOLD');
$sql = mysqli_query($db, "SELECT Distinct Month FROM Attendance");
...
<?php 
$db = mysqli_connect('localhost', 'systemdesign2018', 'System2018!', 'SUNYGOLD');
$sql = mysqli_query($db, "SELECT Distinct Year FROM Attendance");
...
<p><button class="btn" name="SearchAttendance" type="submit">Search</button><input type="reset" value="Clear" /></p>
