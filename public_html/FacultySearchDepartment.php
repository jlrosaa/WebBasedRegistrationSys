...
// REGISTER USER
if (isset($_POST['SendtoSearchDepartment'])) {
...
<form name="AdminGetCourses" form action="FacultyGetCourses.php" method="post"> 
...
<p><button class="btn" name="AdminGetCourses" type="submit">Get Courses</button><input type="reset" value="Clear" /></p>
