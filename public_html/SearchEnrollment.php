<?php include('SearchEnrollTest.php') ?>

<!DOCTYPE html>
<html>
<head><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
	<title>SUNY Gold Search Enrollment</title>
	<style type="text/css">* 
{
...
<div class="topnav"><a href="/Research_Home.html">Home </a>
...
<div class="dropdown-content"><a href="/SearchSchoolData.html">Search School Data</a> <a href="#">Search Users</a> <a href="#">Search Faculty</a></div>
</div>
...
<form name="Search" form action="Enrollment.php" method="post" > 
...
<?php 
$db = mysqli_connect('localhost', 'systemdesign2018', 'System2018!', 'SUNYGOLD');
$sql = mysqli_query($db, "SELECT Distinct Year FROM Enrolled");
