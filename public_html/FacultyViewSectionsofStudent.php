<?php include('FacultyDropStudentData.php')?>
...
if (isset($_POST['SeeStudentsSections'])) {
 ...
 $_Session["UserId"]=$UserId;
     	...
     	$query ="SELECT Section.CRN, Section.CourseId, Section.BuildingName, Section.RoomNumber,Section.Course, Section.TimeSlot, Section.Semester, Section.Semester, Section.Year, Section.Professor, Section.Days, Section.Credits
	FROM Enrolled
...
<td><?php echo $row["Capacity"];?></td></tr>
...
<form method="post" action="FacultyViewSectionsofStudent.php" name="AdminDropStudent">
