...
<div class="dropdown-content"><a href="/DepartmentList.html">List of Departments</a> <a href="/AcademicInformation.html">Academic Information</a><a href="/ImportantDates.html">Important Dates/Deadlines</a><a href="/StudentTranscript.php">Transcript Functions</a></div>
</div>

<div class="dropdown"><button class="dropbtn">Student Menu</button>

<div class="dropdown-content"><a href="#">Course Functions</a> <a href="#">User Functions</a><a href="#">Timeslot Functions</a><a href="#">Location Functions</a></div>
</div>
...
<form name="Enroll" form action="AdminGetCourses2.php" method="post" > 
