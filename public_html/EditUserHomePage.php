<?php include('EditUserEmailData.php') ?>
<?php
session_start();
...
<form action="/EditUserEmail.php" >
  <button type="submit">Edit User Email</button>
</form> 



<form action="/EditUserType.php" >
  <button type="submit">Edit User Type</button>
</form> 
...
<form action="/EditAUser.php" >
  <button type="submit">Edit Both</button>
</form> 
