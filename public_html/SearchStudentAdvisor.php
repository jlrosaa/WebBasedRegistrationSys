...
<head><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
	<title>SUNY Gold Search Advise</title>
	<style type="text/css">* 
{
...
<div class="footer">
<h2>Search for Student Advisor</h2>
...
<form name="StudentAdvisor" form action="StudentAdvisor.php" method="post" > 
...
<p><button class="btn" name="SearchStudentAdvisor" type="submit">Search</button><input type="reset" value="Clear" /></p>
