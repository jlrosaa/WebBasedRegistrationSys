...
<head><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
	<title>SUNY Gold Search Grade</title>
	<style type="text/css">* 
{
...
<div class="footer">
<h2>Search for Faculty Schedule</h2>
...
<form name="SearchGrade" form action="SearchGrades.php" method="post" > 
...
$sql = mysqli_query($db, "SELECT Distinct Course FROM Courses");
...
<p><button class="btn" name="SearchGrades" type="submit">Search</button><input type="reset" value="Clear" /></p>
